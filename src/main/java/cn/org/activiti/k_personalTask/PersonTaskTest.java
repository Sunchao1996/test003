package cn.org.activiti.k_personalTask;
...
public class PersonTaskTest {
    ...
    @Test
    public void delpoy(){
        InputStream inputStreamBpmn = this.getClass().getResourceAsStream("personTask.bpmn");
        InputStream inputStreamPng = this.getClass().getResourceAsStream("personTask.png");
        Deployment deployment = processEngine.getRepositoryService().createDeployment().name("个人任务").addInputStream("personTask.bpmn",inputStreamBpmn)
                .addInputStream("personTask.png",inputStreamPng).deploy();
        System.out.println("部署ID："+deployment.getId());
        System.out.println("部署名称："+deployment.getName());
    }
    @Test
    public void startProcess(){
        String processKey = "personTask";
        Map<String,Object> valueMap = new HashMap<>();
        valueMap.put("userId","张三");
        ProcessInstance pi =  processEngine.getRuntimeService().startProcessInstanceByKey(processKey,valueMap);
